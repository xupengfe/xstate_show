 ...
 *
 * It tests and verifies the basic functions of XSAVE in user space;
 * it tests "FPU, SSE(XMM), AVX2(YMM), AVX512_OPMASK/AVX512_ZMM_Hi256/
 ...
 * AVX512_ZMM_Hi256/AVX512_Hi16_ZMM and PKRU, it can be saved/restored by
 * xsave/xrstor instructions, and mask could control which part will be
 * saved/restored:
 * FP             (0 - 159 bytes)
 * XMM            (160-415 bytes)
 ...
 * To prevent GCC from generating any FP/XMM/AVX/PKRU code by mistake, add
